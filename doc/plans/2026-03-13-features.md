...
- “Talk to the BEEP” feeling for the user.
...
- On dashboard: “Ask the BEEP for a hiring plan” → creates a `strategy` issue/thread scoped to the company.
...
- A user can “ask BEEP” from the dashboard and receive a response in a company-scoped thread.
